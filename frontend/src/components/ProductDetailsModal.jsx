            ...
            <div className="mt-3 text-center sm:mt-0 sm:text-left w-full">
              ...
              <div className="mt-4 flex justify-between items-center border-b border-slate-200 pb-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    {product.seller.isVerified ? 'Verified ✓' : 'Unverified'}
                  </p>
                </div>
                <div className="text-right">
                  <p className="text-sm text-slate-500">Price</p>
                  <p className="text-2xl font-bold text-slate-900">₹{parseFloat(product.price).toFixed(2)}</p>
                </div>
              </div>
              ...
              <div className="mt-4">
                ...
                {loading ? (
                  ...
                  <div className="text-center py-8 text-sm text-slate-500 bg-slate-50 rounded-md border border-slate-100">
